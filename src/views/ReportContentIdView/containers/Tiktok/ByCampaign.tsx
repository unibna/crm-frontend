...
const TiktokByCampaign = () => {
  ...
  const { [STATUS_ROLE_CONTENT_ID.TIKTOK_BY_CAMPAIGN]: columns, params: paramsStore } = store;
  ...
  const { dataAttributeRule, dataFilterCustomer } = filterContentId;
  ...
  const renderHeader = () => {
    ...
    return (
      <HeaderFilter
        ...
        onChangeColumn={(columns) => updateCell(STATUS_ROLE_CONTENT_ID.TIKTOK_BY_CAMPAIGN, columns)}
      ...
      <Grid item xs={12} md={12} lg={12}>
        <DataGrid
          ...
          setColumnWidths={(columns) =>
            resizeColumn(STATUS_ROLE_CONTENT_ID.TIKTOK_BY_CAMPAIGN, columns)
          }
          handleChangeColumnOrder={(columns) =>
            orderColumn(STATUS_ROLE_CONTENT_ID.TIKTOK_BY_CAMPAIGN, columns)
          }
        />
      </Grid>
    </Grid>
...
export default TiktokByCampaign;
