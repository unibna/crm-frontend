...
const ZnsZaloTable = ({
  ...
  const [data, setData] = useState<{ data: any[]; loading: boolean; count: number }>({
    data: [],
    count: 0,
    loading: false,
  });
  const [params, setParams] = useState({ limit: 200, page: 1, ordering: "-created" });
