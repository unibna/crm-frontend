...
var useFieldArray = (props) => {
  ...
  const [fields, setFields] = import_react.default.useState(mapIds(control._getFieldArray(name), keyName));
  ...
  const updateValues = import_react.default.useCallback((updatedFieldArrayValuesWithKey) => {
  ...
  return {
    swap: import_react.default.useCallback(swap, [updateValues, name, control, keyName]),
    move: import_react.default.useCallback(move, [updateValues, name, control, keyName]),
    prepend: import_react.default.useCallback(prepend$1, [updateValues, name, control, keyName]),
    append: import_react.default.useCallback(append$1, [updateValues, name, control, keyName]),
    remove: import_react.default.useCallback(remove, [updateValues, name, control, keyName]),
    insert: import_react.default.useCallback(insert$1, [updateValues, name, control, keyName]),
    update: import_react.default.useCallback(update, [updateValues, name, control, keyName]),
    replace: import_react.default.useCallback(replace, [updateValues, name, control, keyName]),
    fields
  };
};
...
//# sourceMappingURL=chunk-PO3XV4DT.js.map
