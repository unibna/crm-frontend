    ...
    o3 ? t(r3) && r3[Q].A === n2 && e2(n2.p) : (n2.u && function n3(t2) {
      if (t2 && "object" == typeof t2) {
        ...
        if (r4) {
          ...
          if (4 === c2)
            i(o4, function(t3) {
              t3 !== Q && (void 0 !== e3[t3] || u(e3, t3) ? f3[t3] || n3(o4[t3]) : (f3[t3] = true, k(r4)));
            }), i(e3, function(n4) {
              void 0 !== o4[n4] || u(o4, n4) || (f3[n4] = false, k(r4));
            });
          else if (5 === c2) {
      ...
      case 2:
        return function(n3, t3, r3, e4) {
          ...
          i(n3.D, function(n4, i2) {
            ...
            if (v2 !== p2 || "replace" !== l2) {
              var d2 = t3.concat(n4);
              r3.push("remove" === l2 ? { op: l2, path: d2 } : { op: l2, path: d2, value: p2 }), e4.push(l2 === c2 ? { op: "remove", path: d2 } : "remove" === l2 ? { op: c2, path: d2, value: f2(v2) } : { op: "replace", path: d2, value: f2(v2) });
            }
          });
        }(n2, t2, r2, e3);
      case 5:
...
function C() {
  ...
  var a2 = function(n2, t3) {
    ...
    return Object.defineProperty(o3, "size", { get: function() {
      ...
      var n3 = this[Q];
      u2(n3), p(n3).size && (e2(n3), k(n3), n3.D = /* @__PURE__ */ new Map(), i(n3.t, function(t3) {
        n3.D.set(t3, false);
      }), n3.o.clear());
...
//# sourceMappingURL=chunk-C46QMQHQ.js.map
