  ...
  function PluginIndexer2() {
    ...
    _this.memoize = function(index, positionContext) {
      ...
      var fn = function() {
        ...
        return __spread2(calculatedPosition, [index]);
      };
...
var RefHolder = (0, import_react.forwardRef)(function(_a, ref) {
  ...
  return (0, import_react.isValidElement)(children) ? typeof children.type === "string" ? (0, import_react.cloneElement)(children, { ref }) : (0, import_react.cloneElement)(children, { forwardedRef: ((_b = children.props) === null || _b === void 0 ? void 0 : _b.forwardedRef) ? function(node) {
  ...
  } : ref }) : (0, import_react.createElement)("div", { ref, style: { display: "contents" } }, children);
});
...
var Sizer = function(_super) {
  ...
  function Sizer2(props) {
    ...
    _this.getSize = function() {
      return { height: _this.rootNode.clientHeight, width: _this.rootNode.clientWidth };
    };
...
var RefType = (0, import_prop_types.shape)({
  current: (0, import_prop_types.instanceOf)(typeof Element !== "undefined" ? Element : Object)
});
...
@devexpress/dx-react-core/dist/dx-react-core.es.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-GVMU73SV.js.map
