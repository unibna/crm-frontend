...
export declare class BaseTooltip extends ChartData {
    ...
    createTooltip(chart: Chart | AccumulationChart, isFirst: boolean, location: ChartLocation, clipLocation: ChartLocation, point: Points | AccPoints, shapes: ChartShape[], offset: number, bounds: Rect, crosshairEnabled?: boolean, extraPoints?: PointData[], templatePoint?: Points | AccPoints, customTemplate?: string): void;
    private findPalette;
    private findColor;
